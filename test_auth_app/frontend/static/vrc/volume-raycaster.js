...
//	"Aneurysm": "3ykigaiym8uiwbp/aneurism_256x256x256_uint8.raw",
	"CT": "/frontend/static/vrc/initct_256x256x248_uint8.raw",
};
...
var selectVolume = function() {
	...
	loadLocalVolume(volumes[selection], function(file, dataBuffer) {
		var m = file.match(fileRegex);
		var volDims = [parseInt(m[2]), parseInt(m[3]), parseInt(m[4])];
...
window.onload = function(){
	...
	colormapImage.src = "/frontend/static/vrc/colormaps/cool-warm-paraview.png";
}
